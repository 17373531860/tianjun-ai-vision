...
**本文件最后更新**：2026-09-19（发版 v3.60.0：六和二工位锁付整改批次——整板拖动重配准/扩边救援/混合逐件虚拟步骤，全部默认关；第一节版本号 + 第十一节里程碑同步，无新路由前缀。上一版 v3.59.0：容器定界周期）
**维护者**：项目主作者 + AI agents
