...
**本文件最后更新**：2026-09-17（发版 v3.58.0：dev-qing 合并——多屏工位检测屏跟皮拆参观屏 + 纯自定义条件互斥/空闲超时 + 录像检测框 sidecar 带框归档 + 头姿全角度开关；第一节版本号 + 第十一节里程碑同步，无新路由前缀。上一版 v3.57.0：六批次汇合发版）
**维护者**：项目主作者 + AI agents
