...
**本文件最后更新**：2026-08-14（发版 v3.51.2：摄像头生命周期仿真战役补丁版——Mac 真机 67 断言仿真相机生命周期全路径，修相机格式探测 Strategy 3 macOS 误入 V4L2 重开留死句柄僵尸态（启动成功但画面永远 No Source）+ 全平台终检堵僵尸态出口 + UAT 剧本归档 tests/uat/mac_camera_sim/；第一节版本号 + 第十一节里程碑同步。上一版 v3.51.1：捷昌 B 站双工位虚拟战役补丁版）
**维护者**：项目主作者 + AI agents
