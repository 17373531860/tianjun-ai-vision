...
**本文件最后更新**：2026-09-01（发版 v3.56.0：周期多码采集子系统 + 并行簇收编；第一节版本号 + 第五节路由表 `/scan-collect/*` + 第十一节里程碑同步。上一版 v3.55.0：按工位 logic_mode 切工艺面板）
**维护者**：项目主作者 + AI agents
