...
**本文件最后更新**：2026-09-21（发版 v3.60.2：六和双工位整改合并——混合逐件「开始判定」开账闸门 + 停用配对行三连修复 + 多码采集「随视觉周期结算」收编 v3.60.1a/b/c；第一节版本号 + 第十一节里程碑同步，无新路由前缀）
**维护者**：项目主作者 + AI agents
