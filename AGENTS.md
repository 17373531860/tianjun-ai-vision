...
**本文件最后更新**：2026-08-15（发版 v3.51.4：交付补全补丁版——安装包收编 sqlite_to_pg 迁移工具（v3.49~v3.51.3 从未进包，v3.51.3 成品解剖审计才发现）+ CI 打包资源自检缺失红灯 + run-tests/build-release skill 沉淀「交付审计逃逸复盘」，无代码行为变更；第一节版本号 + 第十一节里程碑同步。上一版 v3.51.3：捷昌现场夜测反馈补丁版 + PG 组件交付缺口修复）
**维护者**：项目主作者 + AI agents
