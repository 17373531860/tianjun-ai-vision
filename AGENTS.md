...
**本文件最后更新**：2026-07-05（技术债 HIDDEN-1~8 隐式约定文档化：第八节不变量 2/4/7/9/10 条补插件视角，新增 14~17 条一行红线（细节分别下放 debug-mes / debug-alarm / debug-channel skill）。上次发版更新 2026-06-29 v3.31.0）
**维护者**：项目主作者 + AI agents
