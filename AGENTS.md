...
**本文件最后更新**：2026-09-20（发版 v3.60.1：六和芯子装配工位整改补丁——检测模式 `disappear_uninterruptible` 豁免补齐 + 多码采集未绑码警告豁免；第一节版本号 + 第十一节里程碑同步，无新路由前缀）
**维护者**：项目主作者 + AI agents
