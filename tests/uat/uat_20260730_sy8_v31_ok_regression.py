# -*- coding: utf-8 -*-
"""UAT 回归: SY8(v31模型调参版) 跑上银 7-23 正常视频 (4 箱满装 96, 全流程正确) — 别影响合格的.
...
证据: /home/qianqian/uat_sy8_v31_ok_regression/ (run.log + 截图 + 浏览器录像)
"""
import json
import sys
import time
...
OUT = Path("/home/qianqian/uat_sy8_v31_ok_regression")
CH = 0
...
def main():
    ...
    with sync_playwright() as pw:
        ...
        api("post", f"/api/v1/source/detection/start?channel={CH}",
            json={"session_name": "uat_sy8_v31_ok_reg", "models": [
