<template>
  ...
  <div class="p-6 h-full overflow-y-auto">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <SmsPushCard :channel-count="channelCount" />
      ...
      <!-- 协议设置 -->
      <ProtocolSettingsCard :config="config" @save="saveConfig" />
...
import SmsPushCard from './components/SmsPushCard.vue';
import ProtocolSettingsCard from './components/ProtocolSettingsCard.vue';
import FunctionTestCard from './components/FunctionTestCard.vue';
import VoiceBroadcastCard from './components/VoiceBroadcastCard.vue';
