...
def mount_all_routers(app: FastAPI) -> None:
    ...
    # from backend.api import site_pack       # 现场配方包 .tjvsite (WIP: 前端/测试未做, v3.57.0 摘除挂载, 补齐后恢复)
    ...
    # app.include_router(site_pack.router, prefix=f"{v1}/site-pack", tags=["site-pack"])  # WIP 摘除挂载 (见上)
